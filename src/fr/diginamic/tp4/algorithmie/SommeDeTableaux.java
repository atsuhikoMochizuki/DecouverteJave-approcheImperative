...
public class SommeDeTableaux {
    ...
    public static void run() {
        Utils.msgTitle("EXERCICE 5 : SOMME DE TABLEAUX");
    ...
    public static void sumOfTwoArrays(int[] i_array1, int[] i_array2) {
        ...
        Utils.msgInfo("On ajuste les deux tableaux à la même taille...");
        int sizeMax = 0;
        if (i_array1.length < i_array2.length) sizeMax = i_array2.length;
        else sizeMax = i_array1.length;
        ...
        Utils.msgResult("Le tableau résultant de la somme des deux autres est le suivant:");
        for (int i = 0; i < sizeMax; i++)
